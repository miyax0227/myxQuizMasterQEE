...
.factory('$twitterApi', ['$q', '$twitterHelpers', '$http', function($q, $twitterHelpers, $http) {
  ...
  function postRequestMediaUpload(url, neededParams, optionalParams) {
    var deferred = $q.defer();
    if (typeof(optionalParams)==='undefined') optionalParams = {};
    var parameters = angular.extend(optionalParams, neededParams);
    ...
    formData.append('media_data',parameters.media);
  ...
  return {
    ...
    postUploadMedia: function(media_data, parameters) {
      return postRequestMediaUpload(MEDIA_UPLOAD_URL, {media: media_data}, parameters);
    },
    //A custom function in Twitte Api
    postMedia: function (base64Media, parameters) {
       return postRequestMediaUpload(MEDIA_UPLOAD_URL, {media: base64Media}, parameters);
    },
    //A custom function in Twitte Api
